                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('admin.clients.update', $client->id)}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="contact_email" id="contact_email" class="form-control {{$errors->has('contact_email') ? 'is-invalid' : ''}}" placeholder="Ingrese el email del cliente" value="{{old('contact_email', $client->contact_email)}}">
